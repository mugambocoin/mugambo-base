Please check if what you want to add to `mugambo-base` list meets [quality standards](https://github.com/MugamboBC/mugambo-base/blob/master/CONTRIBUTING.md#quality-standard) before sending pull request.
