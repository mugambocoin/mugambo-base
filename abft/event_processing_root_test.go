...
func TestMugamboBFTRandomRoots(t *testing.T) {
	// generated by codegen4MugamboBFTRandomRoot()
	testSpecialNamedRoots(t, `
 A1.01    
 ║         ║        
 ╠════════ B1.01    
...
func testSpecialNamedRoots(t *testing.T, scheme string) {
	...
	// init abft
	lch, _, input := FakeMugamboBFT(nodes, nil)
...
/*
// codegen4MugamboBFTRandomRoot is for test data generation.
func codegen4MugamboBFTRandomRoot() {
	nodes, events := inter.GenEventsByNode(4, 20, 2, nil)

	p, _, input := FakeMugamboBFT(nodes)
	// process events
	config := inter.Events{}
